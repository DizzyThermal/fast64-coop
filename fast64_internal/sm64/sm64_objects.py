    ...
    if obj.data is None:
        ...
        if specialsOnly:
            ...
            if obj.sm64_obj_type == "Object":
                ...
                if obj.sm64_behaviour_enum == "Scroll":
                    area.objects.append(
                        SM64_Object(
                            modelID,
...
def sm64_obj_unregister():
    ...
    del bpy.types.Object.scrollSpeed
    del bpy.types.Object.scrollBehavior
    del bpy.types.Object.affectedVertices
    del bpy.types.Object.scrollType
    del bpy.types.Object.cycleLength
